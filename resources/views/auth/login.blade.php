...
<body class="bg-[--orange]">
  ...
  <section>
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <div data-aos="zoom-in" class="w-full bg-white rounded-lg md:mt-0 sm:max-w-md xl:p-0 login-box">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <a href="#" class="flex mb-6 text-2xl font-semibold text-gray-900 justify-center">
            <img class="w-22 h-20 mr-2" src="/Assets/DarazzMall-logo.png" alt="logo" />
          </a>
            ...
            <div class="space-y-4 md:space-y-6">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-start">
                  <div class="flex items-start">
                    <label for="remember_me" class="text-gray-500">
                      <input id="remember_me" type="checkbox"
                        class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="remember">
                      <span
                        class="w-4 h-4  rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800">{{
                        __('Remember me') }}</span>
                    </label>
                  </div>
              ...
              <button
                class="w-full text-white hover:text-[#f57224] bg-[#f57224] hover:bg-white border-2 border-[#f57224] font-medium mx-auto rounded-lg text-sm px-5 py-2.5 text-center">
                {{ __('Sign in') }}
              </button>
              <p class="text-sm font-light text-gray-500">
                Don't have an account yet?
                <a href="{{ route('register') }}" class="font-medium text-primary-600 hover:underline">Sign up
                </a>
              </p>
